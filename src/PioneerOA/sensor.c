...
static int __pyx_pw_9PioneerOA_6sensor_6Sensor_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_angle = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_angle == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    if (values[1]) {
...
static PyObject *__pyx_pf_9PioneerOA_6sensor_6Sensor_5value___get__(struct __pyx_obj_9PioneerOA_6sensor_Sensor *__pyx_v_self) {
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_self->value); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_9PioneerOA_6sensor_Sensor) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
