...
static PyObject *__pyx_pf_9PioneerOA_6sensor_6Sensor_2__reduce__(struct __pyx_obj_9PioneerOA_6sensor_Sensor *__pyx_v_self); /* proto */
...
static int __pyx_pw_9PioneerOA_6sensor_6Sensor_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_angle = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_angle == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    if (values[1]) {
...
/* Python wrapper */
static PyObject *__pyx_pw_9PioneerOA_6sensor_6Sensor_3__reduce__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_9PioneerOA_6sensor_6Sensor_3__reduce__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce__ (wrapper)", 0);
  __pyx_r = __pyx_pf_9PioneerOA_6sensor_6Sensor_2__reduce__(((struct __pyx_obj_9PioneerOA_6sensor_Sensor *)__pyx_v_self));
...
static PyObject *__pyx_pf_9PioneerOA_6sensor_6Sensor_2__reduce__(struct __pyx_obj_9PioneerOA_6sensor_Sensor *__pyx_v_self) {
  ...
  /* "PioneerOA/sensor.pyx":29
 * 
 *     def __reduce__(self):
 *         return Sensor, (self.angle, self.value)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_self->angle); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->value); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 29, __pyx_L1_error)
...
static PyMethodDef __pyx_methods_9PioneerOA_6sensor_Sensor[] = {
  {"__reduce__", (PyCFunction)__pyx_pw_9PioneerOA_6sensor_6Sensor_3__reduce__, METH_NOARGS, 0},
  {0, 0, 0, 0}
};
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_9PioneerOA_6sensor_Sensor) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_Sensor, (PyObject *)&__pyx_type_9PioneerOA_6sensor_Sensor) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
